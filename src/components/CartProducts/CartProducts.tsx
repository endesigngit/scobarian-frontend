    ...
    <div className={styles.product_list}>
      <div className={styles.product_item}>
        <Link className={styles.product_img__wrap} href={"/"}>
          <Image className={styles.product_img} src={imageOne} width={174} height={231} alt="Picture of product" />
        </Link>
      ...
      <div className={styles.product_item}>
        <Link className={styles.product_img__wrap} href={"/"}>
          <Image className={styles.product_img} src={imagesTo} width={174} height={231} alt="Picture of product" />
        </Link>
        <div className={styles.product_content}>
          <div className={styles.product_header}>
            <Link className={styles.product_title} href={"/"}>
