    ...
    <main className={styles.page_main}>
      <div className={styles.main_grid_container}>
        <div className={styles.left_side}>
          ...
          <div className={clsx(styles.grid_col, styles.page_content)}>
            ...
            <div className={styles.content_wrap}>
              ...
              <p className={styles.description}>
                При соблюдении этих условий мы полностью вернем вам деньги, за исключением стоимости доставки (ст. 26.1
                ФЗ «О защите прав потребителей»). В этом случае расходы на доставку товара продавцу оплачивает
                покупатель.
              </p>
            </div>
            <div className={styles.content_wrap}>
              ...
              <p className={styles.description}>
                ...
                или в мессенджер, и мы оформим возврат быстро и без бюрократии. Расходы на доставку некачественного
                товара берём на себя.
              </p>
            </div>
          </div>
        </div>
